...
def precompute_freqs_cis(args: ModelArgs) -> torch.Tensor:
    ...
    def find_correction_range(
        ...
        low_idx = math.floor(find_correction_dim(low_rot, dim, base, max_seq_len))
        high_idx = math.floor(find_correction_dim(high_rot, dim, base, max_seq_len))
        return max(low_idx, 0), min(high_idx, dim - 1)
